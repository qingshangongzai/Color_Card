<div align="center" style="background: linear-gradient(135deg, #FFEBEA 0%, #FEFFFF 50%, #AEDBFC 100%); padding: 40px 20px; border-radius: 20px; margin: 20px 0;">

<p align="center">
  <img src="./docs/logo.png" alt="Color Card Logo" width="180" style="filter: drop-shadow(0 10px 20px rgba(196, 186, 210, 0.3));">
</p>

<p align="center">
  <span style="background: rgba(255, 255, 255, 0.9); padding: 12px 24px; border-radius: 30px; box-shadow: 0 4px 15px rgba(196, 186, 210, 0.2);">
    <b>🌸 为摄影师和设计师打造的一站式配色工具和图片色彩分析工具 🌸</b>
  </span>
</p>

<p align="center">
  <a href="#中文版"><span style="background: #FFEBEA; color: #4A5568; padding: 6px 16px; border-radius: 20px; box-shadow: 0 2px 8px rgba(255, 235, 234, 0.5);">简体中文</span></a> &nbsp;
  <a href="#english-version"><span style="background: #AEDBFC; color: #2D3748; padding: 6px 16px; border-radius: 20px; box-shadow: 0 2px 8px rgba(174, 219, 252, 0.5);">English</span></a>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/🌸-初樱浅暮-FF6B9D?style=for-the-badge&labelColor=FFEBEA" alt="Theme">
  <img src="https://img.shields.io/badge/配色-FFEBEA-C4BAD2?style=for-the-badge&labelColor=AEDBFC" alt="Colors">
  <img src="https://img.shields.io/badge/版本-v1.9.0-AEDBFC?style=for-the-badge&labelColor=C4BAD2" alt="Version">
</p>
...
<div style="background: linear-gradient(135deg, rgba(255, 235, 234, 0.3) 0%, rgba(174, 219, 252, 0.2) 100%); padding: 25px; border-radius: 16px; margin: 20px 0; border-left: 5px solid #AEDBFC;">

### ✨ 核心功能特色

> <span style="background: linear-gradient(135deg, #FFEBEA, #AEDBFC); padding: 10px 20px; border-radius: 25px; color: #2D3748; box-shadow: 0 4px 15px rgba(174, 219, 252, 0.3);">🎯 **一站式色彩解决方案**</span>
> 
> <span style="color: #4A5568;">从图片分析到配色应用，提供完整的色彩工作流</span>
...
<div style="background: #FEFFFF; padding: 30px; border-radius: 20px; margin: 20px 0; box-shadow: 0 8px 30px rgba(196, 186, 210, 0.15); border: 1px solid rgba(255, 235, 234, 0.5);">
...
<span style="background: linear-gradient(135deg, #FFEBEA, #AEDBFC, #C4BAD2); padding: 12px 24px; border-radius: 24px; color: #2D3748; font-weight: bold;">
🌸 取色卡 (Color Card) - 为摄影师和设计师打造的一站式配色工具 🌸
</span>

<br><br>

<small>Copyright © 2026 浮晓 HXiao Studio · 初樱浅暮配色主题</small>
