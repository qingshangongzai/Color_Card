...
- **内置色彩库**：集成 Open Color、Tailwind CSS、Material Design、Nord、Dracula、Solarized、ColorBrewer、Radix Colors、Rose Pine 和 Nice Color Palettes 十大开源配色方案，提供 13 + 22 + 19 + 16 + 11 + 2 + 35 + 31 + 3 种颜色系列 + 500 组精选配色，总计 652 组色卡，支持一键复制颜色值
