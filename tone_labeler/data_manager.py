...
class DataManager:
    ...
    def export_to_csv(self, output_path: Optional[Path] = None) -> Path:
        ...
        fieldnames = [
            ...
            "P5", "P10", "P25", "P50", "P75", "P90", "P95", "IQR",
            "peak", "peak_sharpness", "peak_height", "peak_neighbor_mean", "span",
            "low_ratio", "mid_ratio", "high_ratio",
            "low_mean", "low_std", "low_pixel_count",
            "mid_mean", "mid_std", "mid_pixel_count",
            "high_mean", "high_std", "high_pixel_count",
            "skewness", "kurtosis", "michelson_contrast",
            "secondary_peak_bin", "secondary_peak_height", "peak_count",
        ...
        with open(output_path, "w", newline="", encoding="utf-8") as f:
            ...
            for record in self._records.values():
                row = {
                    ...
                    "P5": record.features.get("P5", ""),
                    "P10": record.features.get("P10", ""),
                    "P25": record.features.get("P25", ""),
                    "P50": record.features.get("P50", ""),
                    "P75": record.features.get("P75", ""),
                    "P90": record.features.get("P90", ""),
                    "P95": record.features.get("P95", ""),
                    "IQR": record.features.get("IQR", ""),
                    "peak": record.features.get("peak", ""),
                    "peak_sharpness": record.features.get("peak_sharpness", ""),
                    "peak_height": record.features.get("peak_height", ""),
                    "peak_neighbor_mean": record.features.get("peak_neighbor_mean", ""),
                    ...
                    "low_mean": record.features.get("low_mean", ""),
                    "low_std": record.features.get("low_std", ""),
                    "low_pixel_count": record.features.get("low_pixel_count", ""),
                    "mid_mean": record.features.get("mid_mean", ""),
                    "mid_std": record.features.get("mid_std", ""),
                    "mid_pixel_count": record.features.get("mid_pixel_count", ""),
                    "high_mean": record.features.get("high_mean", ""),
                    "high_std": record.features.get("high_std", ""),
                    "high_pixel_count": record.features.get("high_pixel_count", ""),
                    "skewness": record.features.get("skewness", ""),
                    "kurtosis": record.features.get("kurtosis", ""),
                    "michelson_contrast": record.features.get("michelson_contrast", ""),
                    "secondary_peak_bin": record.features.get("secondary_peak_bin", ""),
                    "secondary_peak_height": record.features.get("secondary_peak_height", ""),
                    "peak_count": record.features.get("peak_count", ""),
