...
|  版本  |     日期     |                                    变更内容                                    |
| :--: | :--------: | :------------------------------------------------------------------------: |
| 3.55 | 2026-05-04 | 新增和谐度分析功能：项目结构新增 core/harmony.py（和谐类型判断、评分算法）、dialogs/harmony_dialog.py（和谐度分析对话框含色相环可视化）；更新 utils/theme_colors.py 新增 5 个和谐度相关颜色函数；更新 6 个语言包新增 dialogs.harmony 翻译键和 palette_management.harmony_analysis 翻译键 |
