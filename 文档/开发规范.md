...
|版本 |日期 |变更内容 |
|:---:|:---:|:---:|
|3.40 |2026-03-07 |更新项目结构（1.3节）：新增 export_settings_dialog.py 到 dialogs/ 目录 |
|3.39 |2026-03-04 |新增资源路径规范（2.4节）：说明 PyInstaller 打包后的资源路径获取方式，避免打包后资源加载失败 |
|3.38 |2026-03-04 |更新主题自适应组件实现规范（3.7.3节）：新增注意事项，避免在 _update_styles 中调用 setStyleSheet 设置容器样式 |
...
|3.26 |2026-02-21 |移动 theme_colors.py 到 utils/ |
