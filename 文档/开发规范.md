...
│   ├── preview_widgets.py # 配色预览组件模块（DraggableColorDot、ColorDotBar、BasePreviewScene、PreviewSceneFactory、SVGPreviewWidget、PreviewSceneSelector、PreviewToolbar、MixedPreviewPanel、布局系统：BaseLayout、SingleLayout、ScrollVLayout、ScrollHLayout、GridLayout、MixedLayout、LayoutFactory）
│   ├── zoom_viewer.py     # 缩放查看器模块
│   ├── interfaces.py      # 其他界面面板模块（SettingsInterface、PaletteManagementInterface、PresetColorInterface、ColorPreviewInterface）
